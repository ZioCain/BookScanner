...
jarsigner -sigalg SHA1withRSA -digestalg SHA1 -keystore wpreader.keystore platforms/android/app/build/outputs/apk/release/app-release-unsigned.apk ZioCain
